...
function validerAge(){
   var comboAnnne=document.formu.comboAnnee;
   var index=comboAnnne.selectedIndex;
   var annee=comboAnnne.options[index].value;
   var comboMois=document.formu.comboMois;
   var indexMois=comboMois.selectedIndex;
   var mois=comboMois.options[indexMois].value;
   var comboJour=document.formu.comboJour;
   var indexJour=comboJour.selectedIndex;
   var jour=comboJour.options[indexJour].value;
   var d= new Date();
   ...
   var anne18ms= 18*365*24*3600*1000;
     var annee40ms=40*365*24*3600*1000;
     
     if(d-d2<anne18ms || d-d2>annee40ms){
       document.write(" accees refuse");
       retrun;
        }
